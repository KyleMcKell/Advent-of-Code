...
import { executeDirections, executeOneByOneDirection, formatCrane, formatDirections, getTopOfStacks } from "./index.ts"
...
const executedStacks = executeDirections(directions, stacks, executeOneByOneDirection)
const topOfStacks = getTopOfStacks(executedStacks)

console.log(topOfStacks) // SHQWSRBDL
